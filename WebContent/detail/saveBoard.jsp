...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/TableServlet?key=add" method="post">
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							<td width="80px">状态</td>
							<td><input type="text" name="status" class="InputStyle"/>*</td>
						</tr>
						<tr>
							<td width="80px">预定时间</td>
							<td><input type="text" name="schedule" class="InputStyle"/>*</td>
						</tr>
					</table>
				</div>
            </div>
