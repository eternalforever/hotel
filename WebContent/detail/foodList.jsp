...
<div id="TitleArea">
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath }/DishServlet?key=findByName" method="post">
			<input type="hidden" name="method" value="search">
			<input type="text" name="dishName" title="请输入菜品名称">
    ...
    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
		...
		<c:forEach items="${list}" var="dish">
			<tr class="TableDetail1">
                ...
                <td>${dish.vip}&nbsp;</td>
				<td>
					<a href="${pageContext.request.contextPath}/DishServlet?key=findOne&id=${dish.id}"  class="FunctionButton">更新</a>				
					<a href="${pageContext.request.contextPath}/DishServlet?key=delete&id=${dish.id}" onClick="return delConfirm();"class="FunctionButton">删除</a>				
				</td>
			</tr>
        </c:forEach>
