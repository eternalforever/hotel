...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/DishServlet?key=addDish" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
						...
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="dishName" class="InputStyle" /> *</td>
						</tr>
						<tr>
							<td>价格</td>
                        ...
                        <tr>
							<td>会员价格</td>
							<td><input type="text" name="vip" class="InputStyle" /> *</td>
						</tr>
